...
public class Order {
	...
	/**
	 * @return The list of products in the order, along with
	 * the quantity
	 */
	 ...
	 * @param quantity The amount of this product to be added
	 */
	 ...
	 * @param person The person requesting the order
	 */
	 ...
	 * @param processed The status of the order. True if the
	 * order has been processed, false otherwise
	 */
