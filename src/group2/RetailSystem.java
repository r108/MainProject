...
/*public class RetailSystem {
 ...
 break;
 case 1:
 createNewOrder(this.order);
 break;
 case 2:
 displayOrderList(this.order);
 break;
 case 3:
 stockControl.displayProductByCategory();
 break;
 case 4:
 removeProduct();
 break;
 ...
 break;
 case 1:
 if (stockControl.getStockListSize() > 0) {
 System.out
 ...
 product = new Product(productName, productDescription, productCategory,
 supplierPrice, (Supplier) person);
