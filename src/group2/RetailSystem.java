...
public class RetailSystem {
	...
	public RetailSystem() {
		...
		System.out.println("Retail System ");
		random = new Random();
	...
	//	personDB.displayPersonList(new Staff());
		
		//new Login(personDB);
		//new MainDisplay(personDB);
		//new MainFrame(personDB);
		...
		do{
			...
			case 1:// personDB.personOperation(new Customer()); break;
			case 2:// personDB.personOperation(new Staff()); break;
			case 3:// personDB.personOperation(new Supplier()); break;
