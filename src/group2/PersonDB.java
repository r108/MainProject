...
/**
 * Stores all lists relating to people.
 */
public class PersonDB {
	...
	public Supplier getSupplierById(int id) {
		...
		/*
		 * Search the suppliers list for the supplier, checking if the ID
		 * matches
		 */
	...
	public void automaticallyCreateCustomer() {
		person = new Customer("Roland", "roland@msn.com", "08712345",
				"12 Main Street");
		customerList.add(person);
		person = new Customer("Tom", "tom@msn.com", "08713455",
				"33 Main Street");
		customerList.add(person);
	...
	public void automaticallyCreateStaff() {
		person = new Staff("Jim", "jim@msn.com", "08712345", "123 Main Street",
				"pass", 1);
		staffList.add(person);
		person = new Staff("John", "john@msn.com", "08609382",
				"38 Main Street", "password", 2);
		staffList.add(person);
	}
	...
	public void automaticallyCreateSupplier() {
		person = new Supplier("Poor Buy", "pb@msn.com", "08502274",
				"111 Main Street", "Pat", "x0123");
		supplierList.add(person);
		person = new Supplier("Good Buy", "gb@msn.com", "087512345",
				"200 Main Street", "Kate", "x1234");
		supplierList.add(person);
		person = new Supplier("Better Buy", "bb@msn.com", "087713455",
				"400 Main Street", "Sam", "x2345");
		supplierList.add(person);
		person = new Supplier("Best Buy", "bbb@msn.com", "08599983",
				"600 Main Street", "Fred", "x3456");
		supplierList.add(person);
	}
	 ...
	 * @param accessLevel
	 *            Determines elements visible to staff
	 * @param password
	 *            Password for staff login
	 * @param vatNumber
	 *            VAT number for a supplier
	 * @param contactName
	 *            Contact person for a suppliers business
	 */
	public void createNewPerson(Person person, String name, String email,
			String contactNumber, String address, int accessLevel,
			String password, String vatNumber, String contactName) {
		if (person instanceof Customer) {
			customerList.add(new Customer(name, email, contactNumber, address));
		}
		else if (person instanceof Staff) {
			staffList.add(new Staff(name, email, contactNumber, address,
					password, accessLevel));
		}
		else {
			supplierList.add(new Supplier(name, email, contactNumber, address,
					contactName, vatNumber));
		}
	}

	/**
	 * Edit the details for the person
	 * 
	 * @param person
	 *            The person to edit
	 * @param name
	 ...
	 *            Contact person for a suppliers business
	 */
	public void changePersonDetails(Person person, String name, String email,
			String contactNumber, String address, int accessLevel,
			String password, String vatNumber, String contactName) {
		this.person = person;
		...
		if (((accessLevel == 0) && (password == null))
		...
		else if (((vatNumber == null) && (contactName == null))
				&& ((accessLevel != 0) && (password != null))) {
	...
	/**
	 * Remove a person from the relevant list
	 * 
	 * @param person
