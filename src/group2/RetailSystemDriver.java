...
public class RetailSystemDriver {
	...
	public static final Pattern VALID_CONTACT_NUMBER_REGEX = Pattern.compile(
			"^[0].[0-9]{9,10}$", Pattern.CASE_INSENSITIVE);
	public static final Pattern VALID_ACCESS_LEVEL_REGEX = Pattern.compile(
