...
public class OrderDB {
	...
	private int chartCustomerIndex;
	...
	public int getChartCustomerIndex() {
		return chartCustomerIndex;
	}

	public void setChartCustomerIndex(int chartCustomerIndex) {
		this.chartCustomerIndex = chartCustomerIndex;
	}
