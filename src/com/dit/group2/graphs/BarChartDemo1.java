...
public class BarChartDemo1 extends ApplicationFrame {
	 ...
	 *            the frame title.
	 */
	public BarChartDemo1(String title, double q1_2014, double q2_2014, double q3_2014,
			double q4_2014, double q1_2013, double q2_2013, double q3_2013, double q4_2013,
			double q1_2012, double q2_2012, double q3_2012, double q4_2012) {

		super(title);
		CategoryDataset dataset = createDataset(q1_2014, q2_2014, q3_2014, q4_2014, q1_2013,
				q2_2013, q3_2013, q4_2013, q1_2012, q2_2012, q3_2012, q4_2012);
	 ...
	 * @return The dataset.
	 */
	private static CategoryDataset createDataset(double q1_2014, double q2_2014, double q3_2014,
			double q4_2014, double q1_2013, double q2_2013, double q3_2013, double q4_2013,
			double q1_2012, double q2_2012, double q3_2012, double q4_2012) {
	...
	private static JFreeChart createChart(CategoryDataset dataset) {
		...
		// create the chart...
		JFreeChart chart = ChartFactory.createBarChart("Total Quartly Sales", // chart title
		...
		GradientPaint gp1 = new GradientPaint(0.0f, 0.0f, Color.green, 0.0f, 0.0f, new Color(0, 64,
				0));
		GradientPaint gp2 = new GradientPaint(0.0f, 0.0f, Color.red, 0.0f, 0.0f,
				new Color(64, 0, 0));
	...
	public static void main(String[] args) {
		...
		// BarChartDemo1 demo = new BarChartDemo1("Bar Chart Demo",25,15,10);
		// demo.pack();
