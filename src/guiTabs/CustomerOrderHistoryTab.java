...
public class CustomerOrderHistoryTab extends JPanel implements ComponentListener,
	...
	public void valueChanged(ListSelectionEvent e) {
		if (e.getSource() == orderList) {
			...
			if (orderList.getSelectedIndex() > -1) {
				...
				showOrderDetails(orderDB.getOrderById(Integer.parseInt(values[0].trim()), orderDB
