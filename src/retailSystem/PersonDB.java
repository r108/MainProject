...
public class PersonDB {
	...
	public void automaticallyCreateSupplier() {
		person = new Supplier("Poor Buy", "pb@msn.com", "0850227421", "111 Main Street", "Pat",
				"x0123");
		person.setImageString("Images/poorBuy.jpg");
		supplierList.add(person);
		person = new Supplier("Good Buy", "gb@msn.com", "0875123451", "200 Main Street", "Kate",
				"x1234");
		person.setImageString("Images/goodBuy.jpg");
		supplierList.add(person);
		person = new Supplier("Better Buy", "bb@msn.com", "0877134552", "400 Main Street", "Sam",
				"x2345");
		person.setImageString("Images/betterBuy.jpg");
		supplierList.add(person);
		person = new Supplier("Best Buy", "bbb@msn.com", "0877134552", "600 Main Street", "Fred",
				"x3456");
		person.setImageString("Images/bestBuy.jpg");
		supplierList.add(person);
	}

	public void createNewPerson(Person person, String name, String email, String contactNumber,
			String address, int accessLevel, String password, String vatNumber, String contactName) {
		if (person instanceof Customer) {
			...
			supplierList.add(new Supplier(name, email, contactNumber, address, contactName,
					vatNumber));
		}
	}

	public void changePersonDetails(Person person, String name, String email, String contactNumber,
			String address, int accessLevel, String password, String vatNumber, String contactName) {
		this.person = person;
